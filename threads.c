...
void * BitonicMerge(void* void_args){
	...
	pthread_create(&thread_left, NULL, BitonicMerge, (void*)&left_args);
	pthread_create(&thread_right, NULL, BitonicMerge, (void*)&right_args);
...
void* BitonicSort(void* void_args){
	...
	pthread_create(&thread_left, NULL, BitonicSort, (void*)&left_args);
	pthread_create(&thread_right, NULL, BitonicSort, (void*)&right_args);
